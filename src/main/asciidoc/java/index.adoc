...
To find a single document you use `link:../../apidocs/io/vertx/ext/mongo/MongoService.html#findOne-java.lang.String-io.vertx.core.json.JsonObject-io.vertx.core.Handler-[findOne]`.
